...
For 
cleaning, I separated the original `baker_name` column in `bakers_df` to have 
...
reason why is because the same contestant is named "Jo" in the 
This combined dataframe has information about how each contestant did, what they 
baked, and basic background facts like hometown. 
```{r}
comb_df = 
  comb_df |> 
