...
`r sum(pull(combined_trash, weight_tons))` tons of trash, equivalent to 
`r sum(pull(combined_trash, weight_tons))*2000` pounds.
* `homes_powered`: Combined, they powered 
`r sum(pull(combined_trash, homes_powered))` homes.
...
```
 ...
 Gwynda collected `r gwynda_cigs_06_22` cigarette butts in June of 2022. 
